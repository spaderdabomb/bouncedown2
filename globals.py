...
ACHIEVEMENT_TEXT = ['Score {:n}'.format(ACHIEVEMENT_SCORES[0])+' points',
                    ...
                    'Score {:n}'.format(ACHIEVEMENT_SCORES[15])+' points while small in a single game',
                    'Score {:n}'.format(ACHIEVEMENT_SCORES[16])+' points while small in a single game',
                    'Score {:n}'.format(ACHIEVEMENT_SCORES[17])+' points while small in a single game',
